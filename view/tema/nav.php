...
<!--                    <p class="dropdown-item">'.$_SESSION['user']->nome.'</p>-->
<!--                    <a class="dropdown-item" href="'.HOME_URI.'usuario/logout">Logout</a>-->
<!--                </div>-->
<!--            </div>-->
<!--            --><?php
...
//
//                    echo '<a class="nav-link active" href="'.HOME_URI.'usuario">Usuários</a>';
//
//                }
//            }
//
...
//            }
//            else{
//                echo '<a class="btn btn-primary btn" type="button" href="'.HOME_URI.'usuario/login">LOGIN</a>';
//            }
//            ?>
<!--        </div>-->
<!--    </div>-->
